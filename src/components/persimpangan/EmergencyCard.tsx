    ...
    <div className="bg-bg-card border border-border-color/10 rounded-[24px] p-6 shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col h-full relative">
      ...
      {showModal.active && (
        <div className="absolute inset-0 z-[200] flex items-center justify-center p-4 bg-accent-red/10 backdrop-blur-sm rounded-[24px] animate-fade-in">
          <div className="bg-bg-card border border-accent-red/20 p-6 rounded-2xl shadow-2xl max-w-sm w-full animate-scale-up">
            <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-4 text-white shadow-lg ${activeEmergency === showModal.key ? 'bg-accent-green' : 'bg-accent-red'}`}>
             ...
             <h3 className="text-lg font-black text-text-main mb-2 tracking-tight">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-text-main dark:text-white leading-tight">Kendali Darurat</h2>
          ...
          return (
            <button
              ...
              className={`relative flex items-center justify-center gap-3 p-3.5 rounded-xl border transition-all duration-300 disabled:opacity-40 
                ${isActive
                  ? 'bg-accent-red border-accent-red text-white shadow-[0_4px_12px_rgba(239,68,68,0.3)]'

...
export default function ParameterCard() {
  ...
  return (
    <div className="bg-card border border-border/10 rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-full relative">
      ...
      {showModal.active && (
        <div className="absolute inset-0 z-200 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm rounded-[24px] animate-fade-in">
          <div className="bg-card border border-border/20 p-6 rounded-2xl shadow-2xl max-w-sm w-full animate-scale-up">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-blue-500/10 flex items-center justify-center text-primary shadow-sm">
          ...
          <div>
            <h2 className="text-lg font-bold text-foreground dark:text-black leading-tight">Pengaturan Parameter</h2>
            <p className="text-[11px] text-muted">Konfigurasi algoritma adaptif</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-auto flex gap-3">
        <button
          ...
          disabled={loading}
          className="w-24 bg-transparent border border-border text-muted hover:border-accent-red hover:text-accent-red text-[11px] font-bold py-3 rounded-xl transition-all tracking-widest disabled:opacity-50"
        >
          RESET
        </button>
        <button

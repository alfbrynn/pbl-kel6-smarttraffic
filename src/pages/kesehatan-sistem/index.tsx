      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex gap-3">
            ...
            <button className="bg-accent-cyan text-white px-5 py-2 rounded-[6px] text-[13px] font-bold cursor-pointer transition-all hover:opacity-90 shadow-[0_2px_10_rgba(6,182,212,0.2)]">
              Refresh Dashboard
            </button> */}
          </div>
        </div>
